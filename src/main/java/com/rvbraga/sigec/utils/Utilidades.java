...
public class Utilidades {
	...
	private String statusProcessos[] = { "Inicial", "Recurso Ordinário", "Agrave de Instrumento",
			"Embargos de declaração", "Contestação", "Manifestação sobre Contestação", "Recurso Inominado", };
	private String situacaoProcesso[] = { "Aberto", "Em processamento", "Recusado", "Concluído" };
	private String nivelPrioridade[] = { "Baixa", "Alta", "Urgente" };

	public Utilidades() {

	}

	public List<String> getNivelPrioridade() {
		return Arrays.asList(nivelPrioridade);
	}

	public List<String> getSituacaoProcesso() {
		return Arrays.asList(situacaoProcesso);
	}
	...
	public String translateDayOfWeek(DayOfWeek dayOfWeek) {
		...
		case MONDAY:
			return dias_semana[1];
		case TUESDAY:
			return dias_semana[2];
		case WEDNESDAY:
			return dias_semana[3];
		case THURSDAY:
			return dias_semana[4];
		case FRIDAY:
			return dias_semana[5];
		case SATURDAY:
			return dias_semana[6];
		default:
